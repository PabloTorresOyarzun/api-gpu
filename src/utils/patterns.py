...
PATRONES_INICIO = {
    # 1. FACTURAS COMERCIALES Y DOCUMENTOS TRIBUTARIOS
    "FACTURA_COMERCIAL": [
        # Español
        "FACTURA COMERCIAL", "FACTURA DE EXPORTACION", "FACTURA PROFORMA", "FACTURA",
        "DOCUMENTO TRIBUTARIO ELECTRONICO", "DTE", "COMPROBANTE FISCAL",
        # Inglés
        "COMMERCIAL INVOICE", "EXPORT INVOICE", "PROFORMA INVOICE", "INVOICE",
        "TAX INVOICE", "SALES INVOICE",
        # Alemán
        "HANDELSRECHNUNG", "RECHNUNG", "PROFORMARECHNUNG",
        # Portugués
        "FATURA COMERCIAL", "FATURA", "NOTA FISCAL",
        # Neerlandés
        "HANDELSFACTUUR", "FACTUUR", "PROFORMA FACTUUR",
        # Francés
        "FACTURE COMMERCIALE", "FACTURE", "FACTURE PROFORMA"
    ],
    
    # 2. DOCUMENTOS DE TRANSPORTE (Marítimo/Aéreo/Terrestre)
    "DOCUMENTO_TRANSPORTE": [
        # Español
        "CONOCIMIENTO DE EMBARQUE", "GUÍA AÉREA", "GUIA AEREA", 
        "DETALLE DE LA AEROGUIA", "CARTA DE PORTE",
        "DOCUMENTO DE TRANSPORTE MULTIMODAL", "DOCUMENTO DE TRANSPORTE",
        # Inglés
        "BILL OF LADING", "B/L", "AIR WAYBILL", "AIRWAY BILL", "WAYBILL",
        "ROAD WAYBILL", "SEA WAYBILL",
        "HOUSE AIR WAYBILL", "MASTER AIR WAYBILL", "HAWB", "MAWB", "AWB",
        "COMBINED TRANSPORT",
        "MULTIMODAL TRANSPORT DOCUMENT", "TRANSPORT DOCUMENT",
        "MULTIMODAL BILL OF LADING", "COMBINED TRANSPORT BILL OF LADING", "HBL DRAFT",
        # Alemán
    ...
    "LISTA_EMBALAJE": [
        # Español
        "LISTA DE EMBALAJE", "LISTA DE EMPAQUE", "NOTA DE ENTREGA",
        # Inglés
        "PACKING LIST", "PACKING LIST ORDER",
        "DELIVERY FORM", "DELIVERY NOTE", "DELIVERY DOCKET",
        "TRANSPORT SCOPE", "DISPATCH NOTE", "SHIPPING LIST",
        # Alemán
        "PACKLISTE", "LIEFERSCHEIN", "VERSANDANZEIGE", "LIEFERLISTE",
        # Portugués
        "LISTA DE EMBALAGEM", "NOTA DE ENTREGA",
        # Neerlandés
        "PAKLIJST", "AFLEVERBON", "LEVERINGSNOTA",
        # Francés
        "LISTE DE COLISAGE", "BON DE LIVRAISON", "BORDEREAU DE LIVRAISON"
    ],
    ...
    "POLIZA_SEGURO": [
        ...
        # Inglés
        "INSURANCE POLICY", "INSURANCE CERTIFICATE", "COVER NOTE", "INSURANCE",
        # Alemán
...
# --- PATRONES NEGATIVOS ---
# Frases que deben eliminarse del texto ANTES de clasificar.
# Esto evita falsos positivos (ej. "INVOICE NO." no debe matchear como FACTURA_COMERCIAL).
PATRONES_NEGATIVOS = [
    # Campos de referencia que contienen "INVOICE" pero no son facturas
    "INVOICE NO",
    "INVOICE NO.",
    "INVOICE NUMBER",
    "INVOICE #",
