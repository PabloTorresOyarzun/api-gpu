...
- **ANTI-BUCLES Y ALUCINACIONES:** NUNCA repitas la misma palabra múltiples veces en un solo campo (ej. "MESSRS. MESSRS. MESSRS."). Si el documento solo dice "MESSRS." y no hay nombre, escribe "MESSRS." UNA SOLA VEZ, o mejor aún, devuelve null si no hay datos reales.
